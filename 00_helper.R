...
quarto render # to compile all the files in the project
quarto preview # to see the website in the browser
quarto publish # to publish the website

#### QUARTOPUB FOR PUBLISHING ####

# To select the option to publish to quartopub you need a quartopub account.
